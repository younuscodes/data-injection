...
func (q *Query) String() string {
	...
	if q.Debug {
		s = append(s, "debugQuery=true")
	}

	if q.OmitHeader {
		s = append(s, "omitHeader=true")
	}
...
func (c *Connection) UpdateCsv(payload *[]byte, commit bool) (*UpdateResponse, error) {
	...
	resp, err := HTTPPost(
		SolrUpdateString(c, commit),
		[][]string{{"Content-Type", "application/csv"}},
		payload)
...
func (c *Connection) UpdateJson(payload *[]byte, commit bool) (*UpdateResponse, error) {
